  ...
  "../../node_modules/scheduler/cjs/scheduler.development.js"(exports2) {
    ...
    if (true) {
      (function() {
        ...
        exports2.unstable_runWithPriority = unstable_runWithPriority2;
...
function useFormik(_ref) {
  ...
  var validateFormWithLowPriority = useEventCallback(function(values) {
    ...
    return (0, import_scheduler.unstable_runWithPriority)(import_scheduler.unstable_LowPriority, function() {
  ...
  var validateFormWithHighPriority = useEventCallback(function(values) {
    ...
    return runAllValidations(values).then(function(combinedErrors) {
      if (!!isMounted.current) {
        ...
        if (!(0, import_react_fast_compare.default)(state.errors, combinedErrors)) {
          dispatch({
            type: "SET_ERRORS",
            payload: combinedErrors
          });
