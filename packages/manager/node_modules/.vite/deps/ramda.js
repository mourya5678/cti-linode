...
var F = always_default(false);
var F_default = F;

// ../../node_modules/ramda/es/T.js
var T = always_default(true);
var T_default = T;
...
var adjust = _curry3(function adjust2(fn, idx, list) {
...
var keys3 = _curry1(_keys);
var keys_default = keys3;
...
var identical = _curry2(function identical2(a, b) {
  if (a === b) {
    return a !== 0 || 1 / a === 1 / b;
  } else {
    return a !== a && b !== b;
...
function _equals(a, b, stackA, stackB) {
  ...
  switch (typeA) {
    ...
    case "Number":
    case "String":
      if (!(typeof a === typeof b && identical_default(a.valueOf(), b.valueOf()))) {
        return false;
      }
      break;
    case "Date":
      if (!identical_default(a.valueOf(), b.valueOf())) {
        return false;
      }
      break;
    case "Error":
...
var contains3 = _curry2(_contains);
...
var update = _curry3(function update2(idx, x, list) {
  return adjust_default(always_default(x), idx, list);
});
...
var dissocPath = _curry2(function dissocPath2(path3, obj) {
  switch (path3.length) {
    case 0:
      return obj;
    case 1:
      return isInteger_default(path3[0]) ? remove_default(path3[0], 1, obj) : dissoc_default(path3[0], obj);
    default:
      var head2 = path3[0];
      var tail2 = Array.prototype.slice.call(path3, 1);
      if (obj[head2] == null) {
        return obj;
      } else if (isInteger_default(path3[0])) {
  ...
  switch (type3) {
    ...
    case "function":
      if (set3._nativeSet !== null) {
        ...
        if (!_contains(item, set3._items[type3])) {
          if (shouldAdd) {
...
var intersection = _curry2(function intersection2(list1, list2) {
  ...
  return uniq_default(_filter(flip_default(_contains)(lookupList), filteredList));
});
...
var assign_default = typeof Object.assign === "function" ? Object.assign : _objectAssign;
...
var _stepCatObject = {
  ...
  "@@transducer/step": function(result, input) {
    return assign_default(result, isArrayLike_default(input) ? objOf_default(input[0], input[1]) : input);
  },
  "@@transducer/result": _identity
};
...
var none = _curry2(_complement(_dispatchable(["any"], xany_default, any_default)));
...
var trim3 = _curry1(_trim);
var trim_default = trim3;
...
var without = _curry2(function(xs, list) {
  return reject_default(flip_default(_contains)(xs), list);
});
