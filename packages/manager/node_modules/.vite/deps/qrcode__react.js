...
var require_lib = __commonJS({
  "../../node_modules/qrcode.react/lib/index.js"(exports, module) {
    ...
    var QRCodeCanvas = function(_React$Component) {
      _inherits(QRCodeCanvas2, _React$Component);
      function QRCodeCanvas2() {
        ...
        return _possibleConstructorReturn(_this, (_temp = _this = _possibleConstructorReturn(this, (_ref = QRCodeCanvas2.__proto__ || Object.getPrototypeOf(QRCodeCanvas2)).call.apply(_ref, [this].concat(args))), Object.defineProperty(_assertThisInitialized(_this), "_canvas", {
          configurable: true,
          enumerable: true,
          writable: true,
          value: void 0
      ...
      _createClass(QRCodeCanvas2, [{
        ...
        value: function shouldComponentUpdate(nextProps) {
          var _this2 = this;
          return Object.keys(QRCodeCanvas2.propTypes).some(function(k) {
        ...
        value: function update() {
          var _props = this.props, value = _props.value, size = _props.size, level = _props.level, bgColor = _props.bgColor, fgColor = _props.fgColor;
        ...
        value: function render() {
          var _this3 = this;
          var _props2 = this.props, value = _props2.value, size = _props2.size, level = _props2.level, bgColor = _props2.bgColor, fgColor = _props2.fgColor, style = _props2.style, otherProps = _objectWithoutProperties(_props2, ["value", "size", "level", "bgColor", "fgColor", "style"]);
    ...
    var QRCodeSVG = function(_React$Component2) {
      _inherits(QRCodeSVG2, _React$Component2);
      function QRCodeSVG2() {
        _classCallCheck(this, QRCodeSVG2);
        return _possibleConstructorReturn(this, (QRCodeSVG2.__proto__ || Object.getPrototypeOf(QRCodeSVG2)).apply(this, arguments));
      }
      _createClass(QRCodeSVG2, [{
        ...
        key: "render",
        value: function render() {
          var _props3 = this.props, value = _props3.value, size = _props3.size, level = _props3.level, bgColor = _props3.bgColor, fgColor = _props3.fgColor, otherProps = _objectWithoutProperties(_props3, ["value", "size", "level", "bgColor", "fgColor"]);
          var qrcode = new QRCodeImpl(-1, ErrorCorrectLevel[level]);
          qrcode.addData(convertStr(value));
          qrcode.make();
          var cells = qrcode.modules;
