export declare const CreateTransferSchema: import("yup/lib/object").OptionalObjectSchema<{
    entities: import("yup/lib/object").OptionalObjectSchema<{
...
//# sourceMappingURL=transfers.schema.d.ts.map