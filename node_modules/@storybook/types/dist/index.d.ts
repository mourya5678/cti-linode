...
type ComposedStoryPlayContext = Partial<StoryContext> & Pick<StoryContext, 'canvasElement'>;
type ComposedStoryPlayFn = (context: ComposedStoryPlayContext) => Promise<void> | void;
...
type StoriesWithPartialProps<TRenderer extends Renderer, TModule> = {
    [K in keyof TModule]: TModule[K] extends ComposedStory<infer _, infer TProps> ? AnnotatedStoryFn<TRenderer, Partial<TProps>> : unknown;
};
